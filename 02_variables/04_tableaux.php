...
<body>
  ...
  <div class="container bg-white">
    ...
    <section class="row">
      <div class="col-md-12">
        <h2>4-tableau associatif dans un &lt;>select></h2>
        <p>pour mettre le tableau associatif dans un select, avec une boucle foreach qui fabrique les <code>&lt;option value=""></code><br>
          de la balise select <br>
          <code class="alert-info border "> echo "&lt;label for=\"size2\" class=\" bg-warning border\"> Tailles&lt;/label>&lt;select class=\"form-control w-25 \">>"; <br>
